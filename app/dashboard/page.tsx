...
import { StatCardSkeleton, ListSkeleton } from "@/components/ui/premium-skeleton"
import { FadeIn, StaggeredChildren } from "@/components/ui/page-transition"
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-6 lg:py-12">
        <FadeIn>
          <div className="mb-8 lg:mb-12">
            <div className="h-8 w-48 bg-accent/30 rounded-lg mb-2" />
            <div className="h-5 w-64 bg-accent/20 rounded-lg" />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
            <div className="lg:col-span-8 h-[350px] bg-card/30 border border-border/50 rounded-3xl p-6 lg:p-8" />
            <div className="lg:col-span-4 h-[350px] bg-card/30 border border-border/50 rounded-3xl p-6 lg:p-8" />
            <div className="lg:col-span-6 h-[300px] bg-card/30 border border-border/50 rounded-3xl p-6 lg:p-8" />
            <div className="lg:col-span-6 h-[300px] bg-card/30 border border-border/50 rounded-3xl p-6 lg:p-8" />
          </div>
        </FadeIn>
      </div>
    ...
    <FadeIn>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 mb-12 lg:mb-16">
        ...
        <motion.div
          ...
          className="lg:col-span-12 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border border-primary/20 rounded-3xl p-6 lg:p-8"
        >
          <AiInsights />
        </motion.div>
      </div>
